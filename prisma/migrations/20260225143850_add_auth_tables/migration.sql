...
-- AlterTable
ALTER TABLE "_NewsToTag" ADD CONSTRAINT "_NewsToTag_AB_pkey" PRIMARY KEY ("A", "B");

-- DropIndex
DROP INDEX "_NewsToTag_AB_unique";
...
-- CreateIndex
CREATE INDEX "Prompt_user_id_visibility_idx" ON "Prompt"("user_id", "visibility");
